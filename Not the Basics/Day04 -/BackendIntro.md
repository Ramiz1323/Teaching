...
- **Package code goes into:** `node_modules/`
- **`package.json`** - Tracks which packages you installed and tracks versions
- **`package-lock.json`** - Tracks dependencies of your dependencies and ensures same install across systems
